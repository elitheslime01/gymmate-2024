        ...
        for (let i = 1; i <= totalDays; i++) {
            ...
            days.push(
                <Button
                    ...
                    color={selectedDay === i ? 'white' : isPastDay ? 'gray.500' : 'gray.700'}
                    fontWeight="medium"
                    borderRadius="full"
                    _hover={{
                        bg: selectedDay === i ? '#e65c3b' : isPastDay ? 'gray.200' : 'gray.100'
                    }}
                    _active={{
                        bg: selectedDay === i ? '#cc4a2d' : 'gray.200'
                    }}
                    _disabled={{
                        opacity: 1,
                        cursor: 'not-allowed'
    ...
    return (
        ...
        >
            <CardHeader pb={0}>
                ...
                >
                    <Box>
                        <Text fontSize="lg" fontWeight="semibold">Pick a Visit Date</Text>
                        <Text fontSize="sm" color="gray.500">Choose an available day to begin the walk-in booking.</Text>
                    </Box>
